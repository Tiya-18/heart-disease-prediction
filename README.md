...
This project builds a predictive model using machine learning and deep learning techniques to determine whether a person is likely to have heart disease based on medical attributes.
